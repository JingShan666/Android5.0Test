...
public class SpaceListItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public SpaceListItemDecoration(Context context, boolean isVertical) {
     ...
     */
    public SpaceListItemDecoration(Context context, boolean isVertical, int drawableId) {
     ...
     * @param isVertical 列表方向
     */
    public SpaceListItemDecoration(Context context, int dividerHeight, boolean isVertical) {
     ...
     */
    public SpaceListItemDecoration(Context context, int dividerHeight, boolean isVertical, int dividerColor) {
     ...
     */
    public SpaceListItemDecoration(Context context, int dividerHeight, boolean isVertical, boolean isMarginTopShow, boolean isMarginBottomshow) {
     ...
     */
    public SpaceListItemDecoration(Context context, boolean isVertical,
                                   int drawableId, boolean isMarginTopShow,
                                   boolean isMiddleShow, boolean isMarginBottomshow) {
     ...
     * @param isMarginBottomshow 最后一个条item底部是否需要分割线
     */
    public SpaceListItemDecoration(Context context, int dividerHeight, boolean isVertical, boolean isMarginTopShow, boolean isMiddleShow, boolean isMarginBottomshow) {
     ...
     * @param isMarginBottomshow 最后一个条item底部是否需要分割线
     */
    public SpaceListItemDecoration(Context context, int dividerHeight, boolean isVertical, int dividerColor, boolean isMarginTopShow, boolean isMiddleShow, boolean isMarginBottomshow) {
